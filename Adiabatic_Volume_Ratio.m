%This program will model the adiabatic temperature vs. radius for the photosphere of an AGB star.
...
for i = 1:Maxsteps
  ...
  R = r/r2000K;
  VandV_o = [(4000 - (25000/3)*(((r-r4000K)*r4000K)/power(r,2)))/2000]^(3/7);
  xplot(i) = R;                %Record for plotting.
  yplot(i) = VandV_o;          %Plotting V/V_o.
...
xlabel('R/R_{2000K}');
ylabel('V/V_o');
title('The Adiabatic Volume vs. Radius');

print("Adiabatic_Volume_Plot.png");
refresh;