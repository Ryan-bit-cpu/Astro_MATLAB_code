%This program will model pressure vs. radius for the photosphere of an AGB star.
...
for i = 1:Maxsteps
  ...
  P = [alpha*power((pi*m*k)/(2),0.5)*[4000 - ((25000/3)*(((r-r4000K)*r4000K)/power(r,2)))]^(0.5)]/101325;
